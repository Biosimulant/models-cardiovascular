...
"""Auto-generated SBML BioModule wrapper for Mohr2022 - Rabbit Purkinje Cardiac Electrophysiology.

Source: biomodels_ebi:BIOMD0000001100
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000001100
"""
...
class SbmlMohr2022RabbitPurkinjeCardiacElectrophysiology(biosim.BioModule):
    """BioModule wrapper for SBML model: Mohr2022 - Rabbit Purkinje Cardiac Electrophysiology."""

    def __init__(self, model_path: str = "data/BIOMD0000001100.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Mohr2022RabbitPurkinjeCardiacElectrophysioloBiomd0000001100Model = SbmlMohr2022RabbitPurkinjeCardiacElectrophysiology
