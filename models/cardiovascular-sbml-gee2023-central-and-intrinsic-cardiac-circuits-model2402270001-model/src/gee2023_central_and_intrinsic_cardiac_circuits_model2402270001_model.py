...
"""Auto-generated SBML BioModule wrapper for Gee2023 - Central and intrinsic cardiac circuits.

Source: biomodels_ebi:MODEL2402270001
Original: https://www.ebi.ac.uk/biomodels/MODEL2402270001
"""
...
class SbmlGee2023CentralAndIntrinsicCardiacCircuits(biosim.BioModule):
    """BioModule wrapper for SBML model: Gee2023 - Central and intrinsic cardiac circuits."""

    def __init__(self, model_path: str = "data/MODEL2402270001.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Gee2023CentralAndIntrinsicCardiacCircuitsModel2402270001Model = SbmlGee2023CentralAndIntrinsicCardiacCircuits
