...
"""Visualization sub-model for the Guyton1972 Capillary Dynamics lab.
...
class Guyton1972CapillarydynamicsModel0912160000ModelViz(biosim.BioModule):
    """Pure presentation sub-model — no SBML, no simulation."""

    def __init__(self, integration_step: float = 0.01,
                 lab_title: str = "Guyton1972 Capillary Dynamics",
                 lab_question: str = "Does fluid move into or out of the capillaries?") -> None:
