...
"""Auto-generated SBML BioModule wrapper for Sakmann2000_SodiumCurrent_ModelA.

Source: biomodels_ebi:MODEL1006230021
Original: https://www.ebi.ac.uk/biomodels/MODEL1006230021
"""
...
class SbmlSakmann2000SodiumcurrentModela(biosim.BioModule):
    """BioModule wrapper for SBML model: Sakmann2000_SodiumCurrent_ModelA."""

    def __init__(self, model_path: str = "data/MODEL1006230021.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Sakmann2000SodiumcurrentModelaModel1006230021Model = SbmlSakmann2000SodiumcurrentModela
