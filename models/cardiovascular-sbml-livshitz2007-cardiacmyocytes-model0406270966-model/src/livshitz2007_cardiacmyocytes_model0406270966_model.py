...
"""Auto-generated SBML BioModule wrapper for Livshitz2007_CardiacMyocytes.

Source: biomodels_ebi:MODEL0406270966
Original: https://www.ebi.ac.uk/biomodels/MODEL0406270966
"""
...
class SbmlLivshitz2007Cardiacmyocytes(biosim.BioModule):
    """BioModule wrapper for SBML model: Livshitz2007_CardiacMyocytes."""

    def __init__(self, model_path: str = "data/MODEL0406270966.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Livshitz2007CardiacmyocytesModel0406270966Model = SbmlLivshitz2007Cardiacmyocytes
