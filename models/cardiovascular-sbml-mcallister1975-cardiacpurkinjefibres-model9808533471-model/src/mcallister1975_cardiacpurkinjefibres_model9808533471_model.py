...
"""Auto-generated SBML BioModule wrapper for McAllister1975_CardiacPurkinjeFibres.

Source: biomodels_ebi:MODEL9808533471
Original: https://www.ebi.ac.uk/biomodels/MODEL9808533471
"""
...
class SbmlMcallister1975Cardiacpurkinjefibres(biosim.BioModule):
    """BioModule wrapper for SBML model: McAllister1975_CardiacPurkinjeFibres."""

    def __init__(self, model_path: str = "data/MODEL9808533471.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Mcallister1975CardiacpurkinjefibresModel9808533471Model = SbmlMcallister1975Cardiacpurkinjefibres
