...
"""Auto-generated SBML BioModule wrapper for Noble1998_VentricularCellModel_ModelB.

Source: biomodels_ebi:MODEL1006230080
Original: https://www.ebi.ac.uk/biomodels/MODEL1006230080
"""
...
class SbmlNoble1998VentricularcellmodelModelb(biosim.BioModule):
    """BioModule wrapper for SBML model: Noble1998_VentricularCellModel_ModelB."""

    def __init__(self, model_path: str = "data/MODEL1006230080.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Noble1998VentricularcellmodelModelbModel1006230080Model = SbmlNoble1998VentricularcellmodelModelb
