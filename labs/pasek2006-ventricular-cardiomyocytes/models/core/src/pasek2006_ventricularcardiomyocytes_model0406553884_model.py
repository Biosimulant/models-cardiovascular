...
"""Auto-generated SBML BioModule wrapper for Pasek2006_VentricularCardioMyocytes.
...
class SbmlPasek2006Ventricularcardiomyocytes(biosim.BioModule):
    """BioModule wrapper for SBML model: Pasek2006_VentricularCardioMyocytes."""

    _PORT_TO_SBML: dict[str, str] = {
        "extracellular_sodium": "Nae",
    ...
    def __init__(self, model_path: str = "data/MODEL0406553884.xml", integration_step: float = 0.01) -> None:
    ...
    def inputs(self) -> dict[str, SignalSpec]:
        return {
            "extracellular_sodium": SignalSpec.scalar(
                dtype="float64",
                accepted_profiles=(
                    AcceptedSignalProfile(signal_type="scalar", dtype="float64", accepted_units=("mM",)),
                    AcceptedSignalProfile(signal_type="record", schema={"payload": "json"}),
                ),
                description="Sets extracellular sodium for the simulation scenario. Default `140.0`.",
            ),
            "extracellular_potassium": SignalSpec.scalar(
                dtype="float64",
                accepted_profiles=(
                    AcceptedSignalProfile(signal_type="scalar", dtype="float64", accepted_units=("mM",)),
                    AcceptedSignalProfile(signal_type="record", schema={"payload": "json"}),
                ),
                description="Sets extracellular potassium for the simulation scenario. Default `5.4`.",
            ),
            "extracellular_calcium": SignalSpec.scalar(
                dtype="float64",
                accepted_profiles=(
                    AcceptedSignalProfile(signal_type="scalar", dtype="float64", accepted_units=("mM",)),
                    AcceptedSignalProfile(signal_type="record", schema={"payload": "json"}),
                ),
                description="Sets extracellular calcium for the simulation scenario. Default `1.2`.",
            ),
            "temperature": SignalSpec.scalar(
                ...
                description="Sets temperature for the simulation scenario. Default `295.0`.",
            ),
