...
"""Auto-generated SBML BioModule wrapper for Watanabe2018_State Transition Model with Treatment and Costs.

Source: biomodels_ebi:MODEL1803120006
Original: https://www.ebi.ac.uk/biomodels/MODEL1803120006
"""
...
class SbmlWatanabe2018StateTransitionModelWithTreatmentAndCosts(biosim.BioModule):
    """BioModule wrapper for SBML model: Watanabe2018_State Transition Model with Treatment and Costs."""

    def __init__(self, model_path: str = "data/MODEL1803120006.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Watanabe2018StateTransitionModelWithTreatmeModel1803120006Model = SbmlWatanabe2018StateTransitionModelWithTreatmentAndCosts
