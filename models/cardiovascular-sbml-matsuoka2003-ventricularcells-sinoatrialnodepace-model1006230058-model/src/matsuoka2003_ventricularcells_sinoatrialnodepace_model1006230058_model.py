...
"""Auto-generated SBML BioModule wrapper for Matsuoka2003_VentricularCells_SinoatrialNodePacemaker.

Source: biomodels_ebi:MODEL1006230058
Original: https://www.ebi.ac.uk/biomodels/MODEL1006230058
"""
...
class SbmlMatsuoka2003VentricularcellsSinoatrialnodepacemaker(biosim.BioModule):
    """BioModule wrapper for SBML model: Matsuoka2003_VentricularCells_SinoatrialNodePacemaker."""

    def __init__(self, model_path: str = "data/MODEL1006230058.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Matsuoka2003VentricularcellsSinoatrialnodepaceModel1006230058Model = SbmlMatsuoka2003VentricularcellsSinoatrialnodepacemaker
