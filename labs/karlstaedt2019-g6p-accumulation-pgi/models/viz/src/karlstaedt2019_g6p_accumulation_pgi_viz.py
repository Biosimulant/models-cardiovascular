...
"""Visualization sub-model for the Karlstaedt2019 G6p Accumulation Pgi lab.
...
class Karlstaedt2019G6pAccumulationViaPhosphoglucoModel1910170001ModelViz(biosim.BioModule):
    """Pure presentation sub-model — no SBML, no simulation."""

    def __init__(self, integration_step: float = 0.01,
                 lab_title: str = "Karlstaedt2019 G6p Accumulation Pgi",
                 lab_question: str = "Does phosphoglucose isomerase inhibition accumulate glucose-6-phosphate?") -> None:
