...
"""Visualization sub-model for the Guyton1972 Heart Rate Stroke Volume lab.
...
class Guyton1972HeartratestrokevolumeModel0911270006ModelViz(biosim.BioModule):
    """Pure presentation sub-model — no SBML, no simulation."""

    def __init__(self, integration_step: float = 0.01,
                 lab_title: str = "Guyton1972 Heart Rate Stroke Volume",
                 lab_question: str = "How do heart rate and stroke volume respond?") -> None:
