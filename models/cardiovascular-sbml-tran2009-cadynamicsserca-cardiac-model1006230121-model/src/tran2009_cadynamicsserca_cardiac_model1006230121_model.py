...
"""Auto-generated SBML BioModule wrapper for Tran2009_CaDynamicsSERCA_Cardiac.

Source: biomodels_ebi:MODEL1006230121
Original: https://www.ebi.ac.uk/biomodels/MODEL1006230121
"""
...
class SbmlTran2009CadynamicssercaCardiac(biosim.BioModule):
    """BioModule wrapper for SBML model: Tran2009_CaDynamicsSERCA_Cardiac."""

    def __init__(self, model_path: str = "data/MODEL1006230121.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Tran2009CadynamicssercaCardiacModel1006230121Model = SbmlTran2009CadynamicssercaCardiac
