...
"""Visualization sub-model for the Irvine1999 Cardiac Sodium Channel lab.
...
class Irvine1999CardiacsodiumchannelModel0848062679ModelViz(biosim.BioModule):
    """Pure presentation sub-model — no SBML, no simulation."""

    def __init__(self, integration_step: float = 0.01,
                 lab_title: str = "Irvine1999 Cardiac Sodium Channel",
                 lab_question: str = "How does the cardiac sodium channel recover and inactivate?") -> None:
