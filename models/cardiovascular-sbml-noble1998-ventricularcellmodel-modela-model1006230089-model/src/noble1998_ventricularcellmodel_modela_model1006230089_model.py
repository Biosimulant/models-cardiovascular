...
"""Auto-generated SBML BioModule wrapper for Noble1998_VentricularCellModel_ModelA.

Source: biomodels_ebi:MODEL1006230089
Original: https://www.ebi.ac.uk/biomodels/MODEL1006230089
"""
...
class SbmlNoble1998VentricularcellmodelModela(biosim.BioModule):
    """BioModule wrapper for SBML model: Noble1998_VentricularCellModel_ModelA."""

    def __init__(self, model_path: str = "data/MODEL1006230089.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Noble1998VentricularcellmodelModelaModel1006230089Model = SbmlNoble1998VentricularcellmodelModela
