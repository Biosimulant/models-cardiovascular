...
"""Visualization sub-model for the Guyton1972 Red Cells Viscosity lab.
...
class Guyton1972RedcellsViscosityModel0910928451ModelViz(biosim.BioModule):
    """Pure presentation sub-model — no SBML, no simulation."""

    def __init__(self, integration_step: float = 0.01,
                 lab_title: str = "Guyton1972 Red Cells Viscosity",
                 lab_question: str = "How do red cells change blood viscosity?") -> None:
