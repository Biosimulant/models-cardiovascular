...
The first screenshot shows the canvas and results panel with the absolute state trajectories and baseline-relative challenge response. The second scrolls down to the ranked response chart and the `What Happened` Q&A table for the same L-arginine challenge run.

![Chen2007 NOS lab canvas with absolute and baseline-relative nitric oxide pathway trajectories](assets/chen2007-nos-timeseries-results.png)

![Chen2007 NOS ranked response chart and What Happened summary table](assets/chen2007-nos-response-summary.png)
