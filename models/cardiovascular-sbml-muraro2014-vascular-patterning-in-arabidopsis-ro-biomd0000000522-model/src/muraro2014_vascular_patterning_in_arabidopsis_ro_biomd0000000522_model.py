...
"""Auto-generated SBML BioModule wrapper for Muraro2014 - Vascular patterning in Arabidopsis roots.

Source: biomodels_ebi:BIOMD0000000522
Original: https://www.ebi.ac.uk/biomodels/BIOMD0000000522
"""
...
class SbmlMuraro2014VascularPatterningInArabidopsisRoots(biosim.BioModule):
    """BioModule wrapper for SBML model: Muraro2014 - Vascular patterning in Arabidopsis roots."""

    def __init__(self, model_path: str = "data/BIOMD0000000522.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Muraro2014VascularPatterningInArabidopsisRoBiomd0000000522Model = SbmlMuraro2014VascularPatterningInArabidopsisRoots
