...
"""Auto-generated SBML BioModule wrapper for Earm1990_CalciumDynamics_Cardiac.

Source: biomodels_ebi:MODEL1006230070
Original: https://www.ebi.ac.uk/biomodels/MODEL1006230070
"""
...
class SbmlEarm1990CalciumdynamicsCardiac(biosim.BioModule):
    """BioModule wrapper for SBML model: Earm1990_CalciumDynamics_Cardiac."""

    def __init__(self, model_path: str = "data/MODEL1006230070.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Earm1990CalciumdynamicsCardiacModel1006230070Model = SbmlEarm1990CalciumdynamicsCardiac
