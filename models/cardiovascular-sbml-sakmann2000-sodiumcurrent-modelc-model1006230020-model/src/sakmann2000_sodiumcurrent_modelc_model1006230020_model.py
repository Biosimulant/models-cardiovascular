...
"""Auto-generated SBML BioModule wrapper for Sakmann2000_SodiumCurrent_ModelC.

Source: biomodels_ebi:MODEL1006230020
Original: https://www.ebi.ac.uk/biomodels/MODEL1006230020
"""
...
class SbmlSakmann2000SodiumcurrentModelc(biosim.BioModule):
    """BioModule wrapper for SBML model: Sakmann2000_SodiumCurrent_ModelC."""

    def __init__(self, model_path: str = "data/MODEL1006230020.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Sakmann2000SodiumcurrentModelcModel1006230020Model = SbmlSakmann2000SodiumcurrentModelc
