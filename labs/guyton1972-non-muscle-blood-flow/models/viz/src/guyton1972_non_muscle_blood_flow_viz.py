...
"""Visualization sub-model for the Guyton1972 Non Muscle Blood Flow lab.
...
class Guyton1972NonmusclebloodflowcontrolModel0911169699ModelViz(biosim.BioModule):
    """Pure presentation sub-model — no SBML, no simulation."""

    def __init__(self, integration_step: float = 0.01,
                 lab_title: str = "Guyton1972 Non Muscle Blood Flow",
                 lab_question: str = "How is non-muscle tissue blood flow regulated?") -> None:
