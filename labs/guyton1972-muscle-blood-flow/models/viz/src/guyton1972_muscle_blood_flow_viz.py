...
"""Visualization sub-model for the Guyton1972 Muscle Blood Flow lab.
...
class Guyton1972MusclebloodflowcontrolModel0911202318ModelViz(biosim.BioModule):
    """Pure presentation sub-model — no SBML, no simulation."""

    def __init__(self, integration_step: float = 0.01,
                 lab_title: str = "Guyton1972 Muscle Blood Flow",
                 lab_question: str = "Does active muscle receive more blood flow?") -> None:
