...
"""Auto-generated SBML BioModule wrapper for Guyton1972_Aldosterone.
...
class SbmlGuyton1972Aldosterone(biosim.BioModule):
    """BioModule wrapper for SBML model: Guyton1972_Aldosterone."""
    ...
    def __init__(self, model_path: str = "data/MODEL0911376350.xml", integration_step: float = 0.01) -> None:
    ...
    def inputs(self) -> dict[str, SignalSpec]:
        return {
            ...
            "potassium_effect": SignalSpec.scalar(
                dtype="float64",
                accepted_profiles=(
                    AcceptedSignalProfile(signal_type="scalar", dtype="float64", accepted_units=("dimensionless",)),
                    AcceptedSignalProfile(signal_type="record", schema={"payload": "json"}),
                ),
                description="Sets potassium effect for the simulation scenario. Default `4.44092`.",
            ),
            "sympathetic_drive": SignalSpec.scalar(
                ...
                description="Sets sympathetic drive for the simulation scenario. Default `0.65`.",
            ),
