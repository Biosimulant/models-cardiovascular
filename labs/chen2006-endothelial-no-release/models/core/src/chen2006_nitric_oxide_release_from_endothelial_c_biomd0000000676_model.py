...
"""Auto-generated SBML BioModule wrapper for Chen2006 - Nitric Oxide Release from Endothelial Cells.
...
class SbmlChen2006NitricOxideReleaseFromEndothelialCells(biosim.BioModule):
    """BioModule wrapper for SBML model: Chen2006 - Nitric Oxide Release from Endothelial Cells."""
    ...
    def __init__(self, model_path: str = "data/BIOMD0000000676.xml", integration_step: float = 0.01) -> None:
    ...
    def inputs(self) -> dict[str, SignalSpec]:
        return {
            "l_arginine": SignalSpec.scalar(
                dtype="float64",
                accepted_profiles=(
                    AcceptedSignalProfile(signal_type="scalar", dtype="float64", accepted_units=("dimensionless",)),
                    AcceptedSignalProfile(signal_type="record", schema={"payload": "json"}),
                ),
                description="Sets L-arginine for the simulation scenario. Default `100`.",
            ),
            "oxygen": SignalSpec.scalar(
                dtype="float64",
                accepted_profiles=(
                    AcceptedSignalProfile(signal_type="scalar", dtype="float64", accepted_units=("dimensionless",)),
                    AcceptedSignalProfile(signal_type="record", schema={"payload": "json"}),
                ),
                description="Sets oxygen for the simulation scenario. Default `150`.",
            ),
            "nitric_oxide_synthase_pool": SignalSpec.scalar(
                dtype="float64",
                accepted_profiles=(
                    AcceptedSignalProfile(signal_type="scalar", dtype="float64", accepted_units=("dimensionless",)),
                    AcceptedSignalProfile(signal_type="record", schema={"payload": "json"}),
                ),
                description="Sets nitric oxide synthase pool for the simulation scenario. Default `0.015`.",
            ),
            "arg_binding_rate": SignalSpec.scalar(
                dtype="float64",
                accepted_profiles=(
                    AcceptedSignalProfile(signal_type="scalar", dtype="float64", accepted_units=("dimensionless",)),
                    AcceptedSignalProfile(signal_type="record", schema={"payload": "json"}),
                ),
                description="Sets arg binding rate for the simulation scenario. Default `0.1`.",
            ),
            "oxygen_binding_rate": SignalSpec.scalar(
                dtype="float64",
                accepted_profiles=(
                    AcceptedSignalProfile(signal_type="scalar", dtype="float64", accepted_units=("dimensionless",)),
                    AcceptedSignalProfile(signal_type="record", schema={"payload": "json"}),
                ),
                description="Sets oxygen binding rate for the simulation scenario. Default `1.89`.",
            ),
