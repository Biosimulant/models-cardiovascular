...
"""Auto-generated SBML BioModule wrapper for Yanagihara1980_PacemakerActivity.

Source: biomodels_ebi:MODEL1006230072
Original: https://www.ebi.ac.uk/biomodels/MODEL1006230072
"""
...
class SbmlYanagihara1980Pacemakeractivity(biosim.BioModule):
    """BioModule wrapper for SBML model: Yanagihara1980_PacemakerActivity."""

    def __init__(self, model_path: str = "data/MODEL1006230072.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Yanagihara1980PacemakeractivityModel1006230072Model = SbmlYanagihara1980Pacemakeractivity
