...
![Guyton1972 aldosterone lab canvas with absolute and baseline-relative angiotensin-drive response trajectories](assets/guyton1972-aldosterone-timeseries-results.png)

![Guyton1972 aldosterone ranked response chart and What Happened summary table](assets/guyton1972-aldosterone-response-summary.png)
...
| `potassium_effect` | Sets potassium effect for the scenario. | 4.44092 | — |
| `sympathetic_drive` | Sets sympathetic drive for the scenario. | 0.65 | — |
...
- License: `CC0` (from upstream BioModels entry [biomodels_ebi:MODEL0911376350](https://www.ebi.ac.uk/biomodels/MODEL0911376350)).
...
| `ANM` | ANM | 0.987545 |
| `CKE` | CKE | 4.44092 |
| `ANMAL` | ANMAL | _(unset)_ |
| `OSMAL` | OSMAL | _(unset)_ |
| `AMR1` | AMR1 | _(unset)_ |
| `AMRBSC` | AMRBSC | _(unset)_ |
| `AMRT` | AMRT | _(unset)_ |
| `AMR` | AMR | _(unset)_ |
| `AMC` | AMC | 1 |
| `AM` | AM | _(unset)_ |
