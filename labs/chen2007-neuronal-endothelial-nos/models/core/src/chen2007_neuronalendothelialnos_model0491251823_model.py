...
"""Auto-generated SBML BioModule wrapper for Chen2007_NeuronalEndothelialNOS.
...
class SbmlChen2007Neuronalendothelialnos(biosim.BioModule):
    """BioModule wrapper for SBML model: Chen2007_NeuronalEndothelialNOS."""
    ...
    def __init__(self, model_path: str = "data/MODEL0491251823.xml", integration_step: float = 0.01) -> None:
    ...
    def inputs(self) -> dict[str, SignalSpec]:
        return {
            "l_arginine": SignalSpec.scalar(
                ...
                description="Sets L-arginine for the simulation scenario. Default `0.0`.",
            ),
            "oxygen": SignalSpec.scalar(
                ...
                description="Sets oxygen for the simulation scenario. Default `0.0`.",
            ),
            "nitric_oxide_synthase_pool": SignalSpec.scalar(
                ...
                description="Sets nitric oxide synthase pool for the simulation scenario. Default `0.3`.",
            ),
