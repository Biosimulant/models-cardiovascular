...
"""Visualization sub-model for the Guyton1972 Atrial Natriuretic Peptide lab.
...
class Guyton1972AtrialnatriureticpeptideModel0911272039ModelViz(biosim.BioModule):
    """Pure presentation sub-model — no SBML, no simulation."""

    def __init__(self, integration_step: float = 0.01,
                 lab_title: str = "Guyton1972 Atrial Natriuretic Peptide",
                 lab_question: str = "Does atrial stretch trigger natriuretic response?") -> None:
