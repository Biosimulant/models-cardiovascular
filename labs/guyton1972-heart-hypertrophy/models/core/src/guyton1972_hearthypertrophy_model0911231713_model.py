...
"""Auto-generated SBML BioModule wrapper for Guyton1972_HeartHypertrophy.
...
class SbmlGuyton1972Hearthypertrophy(biosim.BioModule):
    """BioModule wrapper for SBML model: Guyton1972_HeartHypertrophy."""
    ...
    def __init__(self, model_path: str = "data/MODEL0911231713.xml", integration_step: float = 0.01) -> None:
    ...
    def inputs(self) -> dict[str, SignalSpec]:
        return {
            "aortic_flow": SignalSpec.scalar(
                dtype="float64",
                accepted_profiles=(
                    AcceptedSignalProfile(signal_type="scalar", dtype="float64", accepted_units=("dimensionless",)),
                    AcceptedSignalProfile(signal_type="record", schema={"payload": "json"}),
                ),
                description="Sets aortic flow for the simulation scenario. Default `5.00707`.",
            ),
            ...
            "pulmonary_artery_pressure": SignalSpec.scalar(
                dtype="float64",
                accepted_profiles=(
                    AcceptedSignalProfile(signal_type="scalar", dtype="float64", accepted_units=("dimensionless",)),
                    AcceptedSignalProfile(signal_type="record", schema={"payload": "json"}),
                ),
                description="Sets pulmonary artery pressure for the simulation scenario. Default `15.6376`.",
            ),
