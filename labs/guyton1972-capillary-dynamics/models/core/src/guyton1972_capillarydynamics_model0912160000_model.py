...
"""Auto-generated SBML BioModule wrapper for Guyton1972_CapillaryDynamics.
...
class SbmlGuyton1972Capillarydynamics(biosim.BioModule):
    """BioModule wrapper for SBML model: Guyton1972_CapillaryDynamics."""
    ...
    def __init__(self, model_path: str = "data/MODEL0912160000.xml", integration_step: float = 0.01) -> None:
    ...
    def inputs(self) -> dict[str, SignalSpec]:
        return {
            "capillary_pressure": SignalSpec.scalar(
                ...
                description="Sets capillary pressure for the simulation scenario. Default `16.9144`.",
            ),
            "filtration_coefficient": SignalSpec.scalar(
                dtype="float64",
                accepted_profiles=(
                    AcceptedSignalProfile(signal_type="scalar", dtype="float64", accepted_units=("dimensionless",)),
                    AcceptedSignalProfile(signal_type="record", schema={"payload": "json"}),
                ),
                description="Sets filtration coefficient for the simulation scenario. Default `-4.078e-07`.",
            ),
