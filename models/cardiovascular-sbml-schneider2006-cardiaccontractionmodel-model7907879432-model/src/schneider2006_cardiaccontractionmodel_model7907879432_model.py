...
"""Auto-generated SBML BioModule wrapper for Schneider2006_CardiacContractionModel.

Source: biomodels_ebi:MODEL7907879432
Original: https://www.ebi.ac.uk/biomodels/MODEL7907879432
"""
...
class SbmlSchneider2006Cardiaccontractionmodel(biosim.BioModule):
    """BioModule wrapper for SBML model: Schneider2006_CardiacContractionModel."""

    def __init__(self, model_path: str = "data/MODEL7907879432.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Schneider2006CardiaccontractionmodelModel7907879432Model = SbmlSchneider2006Cardiaccontractionmodel
