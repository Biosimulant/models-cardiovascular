...
"""Visualization sub-model for the Guyton1972 Volume Receptors lab.
...
class Guyton1972VolumereceptorsModel0909931851ModelViz(biosim.BioModule):
    """Pure presentation sub-model — no SBML, no simulation."""

    def __init__(self, integration_step: float = 0.01,
                 lab_title: str = "Guyton1972 Volume Receptors",
                 lab_question: str = "Do volume receptors detect volume expansion?") -> None:
