...
"""Auto-generated SBML BioModule wrapper for DiFrancesco1985_CardiacElectricalActivity.

Source: biomodels_ebi:MODEL0912768548
Original: https://www.ebi.ac.uk/biomodels/MODEL0912768548
"""
...
class SbmlDifrancesco1985Cardiacelectricalactivity(biosim.BioModule):
    """BioModule wrapper for SBML model: DiFrancesco1985_CardiacElectricalActivity."""

    def __init__(self, model_path: str = "data/MODEL0912768548.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Difrancesco1985CardiacelectricalactivityModel0912768548Model = SbmlDifrancesco1985Cardiacelectricalactivity
