...
"""Auto-generated SBML BioModule wrapper for Grandi2009_VentricularMyocyte.

Source: biomodels_ebi:MODEL1006230092
Original: https://www.ebi.ac.uk/biomodels/MODEL1006230092
"""
...
class SbmlGrandi2009Ventricularmyocyte(biosim.BioModule):
    """BioModule wrapper for SBML model: Grandi2009_VentricularMyocyte."""

    def __init__(self, model_path: str = "data/MODEL1006230092.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Grandi2009VentricularmyocyteModel1006230092Model = SbmlGrandi2009Ventricularmyocyte
