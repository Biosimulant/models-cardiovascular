...
"""Visualization sub-model for the Iyer2007 Arrhythmia Cardiac Death lab.
...
class Iyer2007ArrhythmiaCardiacdeathModel1006230030ModelViz(biosim.BioModule):
    """Pure presentation sub-model — no SBML, no simulation."""

    def __init__(self, integration_step: float = 0.01,
                 lab_title: str = "Iyer2007 Arrhythmia Cardiac Death",
                 lab_question: str = "Does abnormal calcium handling create arrhythmogenic behaviour?") -> None:
