...
"""Auto-generated SBML BioModule wrapper for Pandit2003_VentricularMyocytes.

Source: biomodels_ebi:MODEL8685104549
Original: https://www.ebi.ac.uk/biomodels/MODEL8685104549
"""
...
class SbmlPandit2003Ventricularmyocytes(biosim.BioModule):
    """BioModule wrapper for SBML model: Pandit2003_VentricularMyocytes."""

    def __init__(self, model_path: str = "data/MODEL8685104549.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Pandit2003VentricularmyocytesModel8685104549Model = SbmlPandit2003Ventricularmyocytes
