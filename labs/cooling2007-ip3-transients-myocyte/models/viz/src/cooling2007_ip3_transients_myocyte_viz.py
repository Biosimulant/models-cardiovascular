...
"""Visualization sub-model for the Cooling2007 Ip3 Transients Myocyte lab.
...
class Cooling2007Ip3transientsCardiacmyocyteBiomd0000000400ModelViz(biosim.BioModule):
    """Pure presentation sub-model — no SBML, no simulation."""

    def __init__(self, integration_step: float = 0.01,
                 lab_title: str = "Cooling2007 Ip3 Transients Myocyte",
                 lab_question: str = "Does inositol trisphosphate stimulation create a calcium transient?") -> None:
