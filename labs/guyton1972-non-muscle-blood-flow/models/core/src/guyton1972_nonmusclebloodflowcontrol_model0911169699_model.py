...
"""Auto-generated SBML BioModule wrapper for Guyton1972_NonMuscleBloodFlowControl.
...
class SbmlGuyton1972Nonmusclebloodflowcontrol(biosim.BioModule):
    """BioModule wrapper for SBML model: Guyton1972_NonMuscleBloodFlowControl."""
    ...
    def __init__(self, model_path: str = "data/MODEL0911169699.xml", integration_step: float = 0.01) -> None:
    ...
    def inputs(self) -> dict[str, SignalSpec]:
        return {
            "tissue_oxygen": SignalSpec.scalar(
                dtype="float64",
                accepted_profiles=(
                    AcceptedSignalProfile(signal_type="scalar", dtype="float64", accepted_units=("dimensionless",)),
                    AcceptedSignalProfile(signal_type="record", schema={"payload": "json"}),
                ),
                description="Sets tissue oxygen for the simulation scenario. Default `35.1148`.",
            ),
            "autonomic_drive": SignalSpec.scalar(
                dtype="float64",
                accepted_profiles=(
                    AcceptedSignalProfile(signal_type="scalar", dtype="float64", accepted_units=("dimensionless",)),
                    AcceptedSignalProfile(signal_type="record", schema={"payload": "json"}),
                ),
                description="Sets autonomic drive for the simulation scenario. Default `0.9`.",
            ),
