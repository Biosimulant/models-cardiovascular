...
"""Auto-generated SBML BioModule wrapper for Guyton1972_HeartRateStrokeVolume.
...
class SbmlGuyton1972Heartratestrokevolume(biosim.BioModule):
    """BioModule wrapper for SBML model: Guyton1972_HeartRateStrokeVolume."""
    ...
    def __init__(self, model_path: str = "data/MODEL0911270006.xml", integration_step: float = 0.01) -> None:
    ...
    def inputs(self) -> dict[str, SignalSpec]:
        return {
            "autonomic_drive": SignalSpec.scalar(
                ...
                description="Sets autonomic drive for the simulation scenario. Default `1.3`.",
            ),
            ...
            "cardiac_output": SignalSpec.scalar(
                dtype="float64",
                accepted_profiles=(
                    AcceptedSignalProfile(signal_type="scalar", dtype="float64", accepted_units=("dimensionless",)),
                    AcceptedSignalProfile(signal_type="record", schema={"payload": "json"}),
                ),
                description="Sets cardiac output for the simulation scenario. Default `4.9943`.",
            ),
