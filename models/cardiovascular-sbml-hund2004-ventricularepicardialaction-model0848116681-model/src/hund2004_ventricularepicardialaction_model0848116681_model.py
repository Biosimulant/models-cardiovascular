...
"""Auto-generated SBML BioModule wrapper for Hund2004_VentricularEpicardialAction.

Source: biomodels_ebi:MODEL0848116681
Original: https://www.ebi.ac.uk/biomodels/MODEL0848116681
"""
...
class SbmlHund2004Ventricularepicardialaction(biosim.BioModule):
    """BioModule wrapper for SBML model: Hund2004_VentricularEpicardialAction."""

    def __init__(self, model_path: str = "data/MODEL0848116681.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Hund2004VentricularepicardialactionModel0848116681Model = SbmlHund2004Ventricularepicardialaction
