...
"""Auto-generated SBML BioModule wrapper for Terkildsen2008_CardiomyocyteFunction.

Source: biomodels_ebi:MODEL7893871775
Original: https://www.ebi.ac.uk/biomodels/MODEL7893871775
"""
...
class SbmlTerkildsen2008Cardiomyocytefunction(biosim.BioModule):
    """BioModule wrapper for SBML model: Terkildsen2008_CardiomyocyteFunction."""

    def __init__(self, model_path: str = "data/MODEL7893871775.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Terkildsen2008CardiomyocytefunctionModel7893871775Model = SbmlTerkildsen2008Cardiomyocytefunction
