...
"""Auto-generated SBML BioModule wrapper for Noble1998_VentricularCellModel_ModelC.

Source: biomodels_ebi:MODEL1006230063
Original: https://www.ebi.ac.uk/biomodels/MODEL1006230063
"""
...
class SbmlNoble1998VentricularcellmodelModelc(biosim.BioModule):
    """BioModule wrapper for SBML model: Noble1998_VentricularCellModel_ModelC."""

    def __init__(self, model_path: str = "data/MODEL1006230063.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Noble1998VentricularcellmodelModelcModel1006230063Model = SbmlNoble1998VentricularcellmodelModelc
