...
"""Auto-generated SBML BioModule wrapper for Pasek2008_VentricularCardioMyocyte.

Source: biomodels_ebi:MODEL0406793751
Original: https://www.ebi.ac.uk/biomodels/MODEL0406793751
"""
...
class SbmlPasek2008Ventricularcardiomyocyte(biosim.BioModule):
    """BioModule wrapper for SBML model: Pasek2008_VentricularCardioMyocyte."""

    def __init__(self, model_path: str = "data/MODEL0406793751.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Pasek2008VentricularcardiomyocyteModel0406793751Model = SbmlPasek2008Ventricularcardiomyocyte
