...
"""Auto-generated SBML BioModule wrapper for Clancy2001_Kchannel.
...
class SbmlClancy2001Kchannel(biosim.BioModule):
    """BioModule wrapper for SBML model: Clancy2001_Kchannel."""
    ...
    def __init__(self, model_path: str = "data/BIOMD0000000121.xml", integration_step: float = 0.01) -> None:
    ...
    def inputs(self) -> dict[str, SignalSpec]:
        return {
            ...
            "intracellular_potassium": SignalSpec.scalar(
                dtype="float64",
                accepted_profiles=(
                    AcceptedSignalProfile(signal_type="scalar", dtype="float64", accepted_units=("mM",)),
                    AcceptedSignalProfile(signal_type="record", schema={"payload": "json"}),
                ),
                description="Sets intracellular potassium for the simulation scenario. Default `140.0`.",
            ),
            "holding_voltage": SignalSpec.scalar(
                ...
                description="Sets holding voltage for the simulation scenario. Default `-40.0`.",
            ),
            "test_voltage": SignalSpec.scalar(
                dtype="float64",
                accepted_profiles=(
                    AcceptedSignalProfile(signal_type="scalar", dtype="float64", accepted_units=("mV",)),
                    AcceptedSignalProfile(signal_type="record", schema={"payload": "json"}),
                ),
                description="Sets test voltage for the simulation scenario. Default `0.0`.",
            ),
