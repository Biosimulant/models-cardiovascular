...
"""Auto-generated SBML BioModule wrapper for Guyton1972_AtrialNatriureticPeptide.
...
class SbmlGuyton1972Atrialnatriureticpeptide(biosim.BioModule):
    """BioModule wrapper for SBML model: Guyton1972_AtrialNatriureticPeptide."""
    ...
    def __init__(self, model_path: str = "data/MODEL0911272039.xml", integration_step: float = 0.01) -> None:
    ...
    def inputs(self) -> dict[str, SignalSpec]:
        return {
            ...
            "atrial_natriuretic_peptide_infusion": SignalSpec.scalar(
                dtype="float64",
                accepted_profiles=(
                    AcceptedSignalProfile(signal_type="scalar", dtype="float64", accepted_units=("dimensionless",)),
                    AcceptedSignalProfile(signal_type="record", schema={"payload": "json"}),
                ),
                description="Sets atrial natriuretic peptide infusion for the simulation scenario. Default `0.0`.",
            ),
