...
"""Auto-generated SBML BioModule wrapper for Sakmann2000_SodiumCurrent_ModelB.

Source: biomodels_ebi:MODEL1006230031
Original: https://www.ebi.ac.uk/biomodels/MODEL1006230031
"""
...
class SbmlSakmann2000SodiumcurrentModelb(biosim.BioModule):
    """BioModule wrapper for SBML model: Sakmann2000_SodiumCurrent_ModelB."""

    def __init__(self, model_path: str = "data/MODEL1006230031.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Sakmann2000SodiumcurrentModelbModel1006230031Model = SbmlSakmann2000SodiumcurrentModelb
