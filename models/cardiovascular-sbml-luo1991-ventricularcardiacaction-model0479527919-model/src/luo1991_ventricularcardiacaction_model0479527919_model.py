...
"""Auto-generated SBML BioModule wrapper for Luo1991_VentricularCardiacAction.

Source: biomodels_ebi:MODEL0479527919
Original: https://www.ebi.ac.uk/biomodels/MODEL0479527919
"""
...
class SbmlLuo1991Ventricularcardiacaction(biosim.BioModule):
    """BioModule wrapper for SBML model: Luo1991_VentricularCardiacAction."""

    def __init__(self, model_path: str = "data/MODEL0479527919.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Luo1991VentricularcardiacactionModel0479527919Model = SbmlLuo1991Ventricularcardiacaction
