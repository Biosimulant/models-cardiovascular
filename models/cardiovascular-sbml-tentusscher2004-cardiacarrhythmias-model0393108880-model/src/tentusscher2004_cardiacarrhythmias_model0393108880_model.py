...
"""Auto-generated SBML BioModule wrapper for tenTusscher2004_CardiacArrhythmias.

Source: biomodels_ebi:MODEL0393108880
Original: https://www.ebi.ac.uk/biomodels/MODEL0393108880
"""
...
class SbmlTentusscher2004Cardiacarrhythmias(biosim.BioModule):
    """BioModule wrapper for SBML model: tenTusscher2004_CardiacArrhythmias."""

    def __init__(self, model_path: str = "data/MODEL0393108880.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Tentusscher2004CardiacarrhythmiasModel0393108880Model = SbmlTentusscher2004Cardiacarrhythmias
