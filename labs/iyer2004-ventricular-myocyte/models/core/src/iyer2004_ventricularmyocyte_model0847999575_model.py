...
"""Auto-generated SBML BioModule wrapper for Iyer2004_VentricularMyocyte.
...
class SbmlIyer2004Ventricularmyocyte(biosim.BioModule):
    """BioModule wrapper for SBML model: Iyer2004_VentricularMyocyte."""
    ...
    def __init__(self, model_path: str = "data/MODEL0847999575.xml", integration_step: float = 0.01) -> None:
    ...
    def inputs(self) -> dict[str, SignalSpec]:
        return {
            ...
            "extracellular_sodium": SignalSpec.scalar(
                ...
                description="Sets extracellular sodium for the simulation scenario. Default `9.798304162`.",
            ),
            "extracellular_potassium": SignalSpec.scalar(
                ...
                description="Sets extracellular potassium for the simulation scenario. Default `125.5589432`.",
            ),
            "intracellular_calcium": SignalSpec.scalar(
                ...
                description="Sets intracellular calcium for the simulation scenario. Default `8.601192016e-05`.",
            ),
