...
"""Auto-generated SBML BioModule wrapper for Guyton1972_MuscleBloodFlowControl.
...
class SbmlGuyton1972Musclebloodflowcontrol(biosim.BioModule):
    """BioModule wrapper for SBML model: Guyton1972_MuscleBloodFlowControl."""
    ...
    def __init__(self, model_path: str = "data/MODEL0911202318.xml", integration_step: float = 0.01) -> None:
    ...
    def inputs(self) -> dict[str, SignalSpec]:
        return {
            "muscle_oxygen": SignalSpec.scalar(
                dtype="float64",
                accepted_profiles=(
                    AcceptedSignalProfile(signal_type="scalar", dtype="float64", accepted_units=("dimensionless",)),
                    AcceptedSignalProfile(signal_type="record", schema={"payload": "json"}),
                ),
                description="Sets muscle oxygen for the simulation scenario. Default `38.0666`.",
            ),
