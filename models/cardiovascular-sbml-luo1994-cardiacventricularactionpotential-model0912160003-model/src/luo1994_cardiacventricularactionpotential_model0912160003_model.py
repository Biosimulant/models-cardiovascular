...
"""Auto-generated SBML BioModule wrapper for Luo1994_CardiacVentricularActionPotential.

Source: biomodels_ebi:MODEL0912160003
Original: https://www.ebi.ac.uk/biomodels/MODEL0912160003
"""
...
class SbmlLuo1994Cardiacventricularactionpotential(biosim.BioModule):
    """BioModule wrapper for SBML model: Luo1994_CardiacVentricularActionPotential."""

    def __init__(self, model_path: str = "data/MODEL0912160003.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Luo1994CardiacventricularactionpotentialModel0912160003Model = SbmlLuo1994Cardiacventricularactionpotential
