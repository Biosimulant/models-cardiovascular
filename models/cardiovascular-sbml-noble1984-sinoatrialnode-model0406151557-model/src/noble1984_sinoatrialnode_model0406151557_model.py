...
"""Auto-generated SBML BioModule wrapper for Noble1984_SinoAtrialNode.

Source: biomodels_ebi:MODEL0406151557
Original: https://www.ebi.ac.uk/biomodels/MODEL0406151557
"""
...
class SbmlNoble1984Sinoatrialnode(biosim.BioModule):
    """BioModule wrapper for SBML model: Noble1984_SinoAtrialNode."""

    def __init__(self, model_path: str = "data/MODEL0406151557.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Noble1984SinoatrialnodeModel0406151557Model = SbmlNoble1984Sinoatrialnode
