...
"""Visualization sub-model for the Iyer2004 Ventricular Myocyte lab.
...
class Iyer2004VentricularmyocyteModel0847999575ModelViz(biosim.BioModule):
    """Pure presentation sub-model — no SBML, no simulation."""

    def __init__(self, integration_step: float = 0.01,
                 lab_title: str = "Iyer2004 Ventricular Myocyte",
                 lab_question: str = "How does a ventricular myocyte action potential respond to pacing and conductance changes?") -> None:
