...
"""Auto-generated SBML BioModule wrapper for Guyton1972_volumeReceptors.
...
class SbmlGuyton1972Volumereceptors(biosim.BioModule):
    """BioModule wrapper for SBML model: Guyton1972_volumeReceptors."""
    ...
    def __init__(self, model_path: str = "data/MODEL0909931851.xml", integration_step: float = 0.01) -> None:
