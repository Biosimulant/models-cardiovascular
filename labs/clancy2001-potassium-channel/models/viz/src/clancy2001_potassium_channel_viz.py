...
"""Visualization sub-model for the Clancy2001 Potassium Channel lab.
...
class Clancy2001KchannelBiomd0000000121ModelViz(biosim.BioModule):
    """Pure presentation sub-model — no SBML, no simulation."""

    def __init__(self, integration_step: float = 0.01,
                 lab_title: str = "Clancy2001 Potassium Channel",
                 lab_question: str = "How does the delayed rectifier potassium channel state distribution respond to voltage?") -> None:
