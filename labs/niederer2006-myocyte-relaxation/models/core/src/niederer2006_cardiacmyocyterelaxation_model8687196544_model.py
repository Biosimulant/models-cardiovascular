...
"""Auto-generated SBML BioModule wrapper for Niederer2006_CardiacMyocyteRelaxation.
...
class SbmlNiederer2006Cardiacmyocyterelaxation(biosim.BioModule):
    """BioModule wrapper for SBML model: Niederer2006_CardiacMyocyteRelaxation."""
    ...
    def __init__(self, model_path: str = "data/MODEL8687196544.xml", integration_step: float = 0.01) -> None:
    ...
    def inputs(self) -> dict[str, SignalSpec]:
        return {
            "troponin_pool": SignalSpec.scalar(
                dtype="float64",
                accepted_profiles=(
                    AcceptedSignalProfile(signal_type="scalar", dtype="float64", accepted_units=("dimensionless",)),
                    AcceptedSignalProfile(signal_type="record", schema={"payload": "json"}),
                ),
                description="Sets troponin pool for the simulation scenario. Default `0.067593139865`.",
            ),
            "relaxation_rate": SignalSpec.scalar(
                dtype="float64",
                accepted_profiles=(
                    AcceptedSignalProfile(signal_type="scalar", dtype="float64", accepted_units=("dimensionless",)),
                    AcceptedSignalProfile(signal_type="record", schema={"payload": "json"}),
                ),
                description="Sets relaxation rate for the simulation scenario. Default `0.002`.",
            ),
            "cooperativity": SignalSpec.scalar(
                dtype="float64",
                accepted_profiles=(
                    AcceptedSignalProfile(signal_type="scalar", dtype="float64", accepted_units=("dimensionless",)),
                    AcceptedSignalProfile(signal_type="record", schema={"payload": "json"}),
                ),
                description="Sets cooperativity for the simulation scenario. Default `0.008`.",
            ),
