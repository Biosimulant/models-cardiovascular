...
"""Auto-generated SBML BioModule wrapper for Fink2008_VentricularActionPotential.

Source: biomodels_ebi:MODEL1006230009
Original: https://www.ebi.ac.uk/biomodels/MODEL1006230009
"""
...
class SbmlFink2008Ventricularactionpotential(biosim.BioModule):
    """BioModule wrapper for SBML model: Fink2008_VentricularActionPotential."""

    def __init__(self, model_path: str = "data/MODEL1006230009.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Fink2008VentricularactionpotentialModel1006230009Model = SbmlFink2008Ventricularactionpotential
