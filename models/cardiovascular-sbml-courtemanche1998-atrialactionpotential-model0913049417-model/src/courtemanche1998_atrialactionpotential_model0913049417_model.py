...
"""Auto-generated SBML BioModule wrapper for Courtemanche1998_AtrialActionPotential.

Source: biomodels_ebi:MODEL0913049417
Original: https://www.ebi.ac.uk/biomodels/MODEL0913049417
"""
...
class SbmlCourtemanche1998Atrialactionpotential(biosim.BioModule):
    """BioModule wrapper for SBML model: Courtemanche1998_AtrialActionPotential."""

    def __init__(self, model_path: str = "data/MODEL0913049417.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Courtemanche1998AtrialactionpotentialModel0913049417Model = SbmlCourtemanche1998Atrialactionpotential
