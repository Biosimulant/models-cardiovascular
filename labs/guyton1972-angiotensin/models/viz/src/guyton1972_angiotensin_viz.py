...
"""Visualization sub-model for the Guyton1972 Angiotensin lab.
...
class Guyton1972AngiotensinModel0911342562ModelViz(biosim.BioModule):
    """Pure presentation sub-model — no SBML, no simulation."""

    def __init__(self, integration_step: float = 0.01,
                 lab_title: str = "Guyton1972 Angiotensin",
                 lab_question: str = "How strongly is the angiotensin system activated?") -> None:
