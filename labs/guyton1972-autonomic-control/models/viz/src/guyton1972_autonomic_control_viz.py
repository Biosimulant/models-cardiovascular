...
"""Visualization sub-model for the Guyton1972 Autonomic Control lab.
...
class Guyton1972AutonomicsModel0911270005ModelViz(biosim.BioModule):
    """Pure presentation sub-model — no SBML, no simulation."""

    def __init__(self, integration_step: float = 0.01,
                 lab_title: str = "Guyton1972 Autonomic Control",
                 lab_question: str = "How does autonomic feedback stabilize circulation?") -> None:
