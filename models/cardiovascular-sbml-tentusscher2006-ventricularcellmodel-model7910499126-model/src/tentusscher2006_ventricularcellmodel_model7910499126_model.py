...
"""Auto-generated SBML BioModule wrapper for TenTusscher2006_VentricularCellModel.

Source: biomodels_ebi:MODEL7910499126
Original: https://www.ebi.ac.uk/biomodels/MODEL7910499126
"""
...
class SbmlTentusscher2006Ventricularcellmodel(biosim.BioModule):
    """BioModule wrapper for SBML model: TenTusscher2006_VentricularCellModel."""

    def __init__(self, model_path: str = "data/MODEL7910499126.xml", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
Tentusscher2006VentricularcellmodelModel7910499126Model = SbmlTentusscher2006Ventricularcellmodel
